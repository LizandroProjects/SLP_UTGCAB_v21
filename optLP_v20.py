...
from functions_v20 import (plot_manipuladas, # plotar manipuladas
...
filename = 'LP_21_vB.hsc'   #VERSÃO ATUAL DO ARQUIVO HYSYS DA SIMULAÇÃO ESSENCIAL'
hconect, simCase, hyApp = Hysysconnect(filename) # Conexão com hysys
...
print('************************************************************************')
cod_speclp, R_min, R_max, R_cap, Carga = SpecLP(simCase, edata, out_obj) # especificações do LP [valores dos limites e cargas]
